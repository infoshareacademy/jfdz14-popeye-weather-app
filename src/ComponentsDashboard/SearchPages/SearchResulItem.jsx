...
class SearchResultItem extends React.Component {
    ...
    get cityDetails() {
        return getCities().find(city => city.long.toFixed(2) === this.long.toFixed(2) && city.lat.toFixed(2) === this.lat.toFixed(2));
    }
        ...
        return (
            <>
                ...
                <div className={style.metadata}>
                    ...
                    <MetadataEntry name="Pressure">{(weather.daily[0].pressure / 100).toFixed(0)} hPa</MetadataEntry>
                    <MetadataEntry name="Humidity">{weather.daily[0].humidity.toFixed(1)}%</MetadataEntry>
                    <MetadataEntry name="Wind speed">{weather.daily[0].wind_speed.toFixed(2)} m/s</MetadataEntry>
