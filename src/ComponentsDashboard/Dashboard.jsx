    ...
    return (
        <>
            <AppContent>
                ...
                <div className="listElement">
                    <LocationOnOutlined/>
                    <span className="dashboardMessage">Information about weather in your current location</span>
                </div>
                <div className="listElement">
                    <SearchOutlined/>
                    <span className="dashboardMessage">Search for different locations and review weather</span>
                </div>
                <div className="listElement">
                    <StarBorderOutlined/>
